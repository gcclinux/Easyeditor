...
# BUILD:
# docker build -t gcclinux/easyeditor:1.7.4 .
# RUN:
# docker run --name EASYEDITOR --rm -p 3024:3024 gcclinux/easyeditor:1.7.4
# CONFIGURE:
# docker run -d --name EASYEDITOR --rm -p 3024:3024 gcclinux/easyeditor:1.7.4
